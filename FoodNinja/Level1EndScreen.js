...
var level1EndState = {
    ...
    init: function (name, score) {
        ...
        var titleText = game.add.text(game.world.centerX, 100, "Getting used to the Buffs?", {
        ...
        nextLevel = game.add.text(game.world.centerX, 450, "Click to go to Level 2.", {
...
function showTip2(){
    ...
    if ((tween !== null && tween.isRunning) || popupTip2.scale.x === 1) {
        tween = game.add.tween(popupTip2.scale).to({ x: 0.1, y: 0.1 }, 1000, Phaser.Easing.Elastic.In, true);
        return;
    }
