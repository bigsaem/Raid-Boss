...
var levelSelectState = {
    ...
    init: function () {
        ...
        warning = game.add.text(300, 380, 'Note: Scores are not saved if you skip levels. No cheating!', {
            fontSize: '17px',
            fill: '#FDFFB5',
        });
...
function goLevel2(){
    game.sound.stopAll();
    this.game.state.start('level2', true, false, undefined, 0);
}
...
function goLevel3(){
    ...
    music = game.add.audio('finalStageBGM');
        music.loop = true;
        music.play();
    this.game.state.start('level3', true, false, undefined, 0);
}
