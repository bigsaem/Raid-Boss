var playerName; //this is the player name, will be sent to database.
...
var popupHowTo;
var tween = null;
var clicked = 0; //checks if a menu option is clicked or not
...
var menuState = {
    ...
    init: function () {
        ...
        newGame.inputEnabled = true; //this is what enables input detection!!!
...
//When starting the game, take user input of name, and pass it to the playGame state.
function startGame() {

    console.log("starting game");
    var prompt = window.prompt("Please enter your name", "Player X");
    playerName = prompt;
    ...
    /*if  (prompt != "") {
        ...
        playerName = prompt;
        var jsonName = JSON.parse(playerName);
