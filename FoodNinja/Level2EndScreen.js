...
var level2EndState = {
    ...
    init: function (name, score) {
        ...
        var titleText = game.add.text(game.world.centerX, 100, "This is the final level.", {
        ...
        nextLevel = game.add.text(game.world.centerX, 450, "Click to proceed to Level 3.", {
            font: '25pt heroes_legendregular',
            fill: '#FDFFB5',
            align: 'center'
        });
...
function showTip(){
    ...
    if ((tween !== null && tween.isRunning) || popupTip3.scale.x === 1) {
        tween = game.add.tween(popupTip3.scale).to({ x: 0.1, y: 0.1 }, 1000, Phaser.Easing.Elastic.In, true);
        return;
    }
