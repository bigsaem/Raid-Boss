...
function spawnFood3(){
    ...
    randomGravity = Math.random() * 300 - 150;
    ...
    if (food[index].body.gravity.y < 0 ){
        food[index].body.gravity.y = 10;
        //game.time.events.repeat(Phaser.Timer.SECOND * 5, 1, foodReverseGravity3, food[actualIndex]);
    }
...
//If food is somehow floating, make it fall again.
function foodGravityReverse(theFood){
    theFood.body.gravity.y = -theFood.body.gravity.y;
}
