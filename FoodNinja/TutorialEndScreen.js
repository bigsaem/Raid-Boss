...
var tutorialEndState = {
    ...
    init: function (score, stageLevel, name) {
        ...
        var titleText = game.add.text(game.world.centerX, 100, "Too Easy? ", {
        ...
        var nextLine = game.add.text(game.world.centerX, 200, "That was just a warm up!", {
        ...
        nextLevel = game.add.text(game.world.centerX, 400, "Click to go to Level 1.", {
...
function showTip0(){
    ...
    if ((tween !== null && tween.isRunning) || popupTip1.scale.x === 1) {
        tween = game.add.tween(popupTip1.scale).to({ x: 0.1, y: 0.1 }, 1000, Phaser.Easing.Elastic.In, true);
        return;
    }
