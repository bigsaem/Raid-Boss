...
var tutorialState  = {
    ...
    preload: function() {
     ...
     /*   game.load.image('sky', 'assets/sky.png');
        ...
        game.load.spritesheet('dude', 'assets/dude.png', 32, 48); //130.222, 78
    ...
    /* //  Now let's create two ledges
       ...
       // player.animations.add('left', [0, 1, 2, 3], 10, true);
        ...
        //Creates hp text
        hpText = game.add.text(50, 50, 'hp: ' + hp, { fontSize: '32px', fill: '#000' });

        //Creates level text for tutorial
        levelText= game.add.text(400, 16, 'Tutorial Stage: 10 foods', { fontSize: '32px', fill: '#000' });

        //Combo text
        comboText: game.add.text(850, 16, 'Combos: ' + combos, { fontSize: '32px', fill: '#000' });

        //Buff text
        buffText: game.add.text(850, 50, 'Buffs: ' + buff, { fontSize: '32px', fill: '#000' });
