$(document).ready(function () {
    ...
    $("#miscDiv > p").click(function() {
        ...
        //if not duplicate, and the # of inputted ingredients is less than 5, add it to the basket
        if (count < 5) {
          var idMisc = $(this).text();
					$("#bdiv" + count + "").show();
          $("#bdiv" + count + " > p").text(idMisc);
          $("#arrow").show(500);
          $("#inc").css("display", "flex");
          ingredients[count] = idMisc;
          console.log(ingredients);
          count++;
        }
      });
    ...
    // When user clicks anywhere outside the search bar, close the search overlay
    ...
    // the functions to show the ingredeients for each of the icons
